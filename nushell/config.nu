...
# }
#
$env.LS_COLORS = "rs=0 di=38;5;33 ln=38;5;51 mh=00 pi=40;38;5;11 so=38;5;13 do=38;5;5
...
$env.config = {
    ...
    buffer_editor: nvim # command that will be used to edit the current line buffer with ctrl+o, if unset fallback to $env.VISUAL and $env.EDITOR
...
$env.FZF_DEFAULT_OPTS = "
 	--color=fg:#100f0f,bg:#FFFCF0,hl:#100F0F
 	--color=fg+:#100f0f,bg+:#F2F0E5,hl+:#100F0F
